  ...
  return (
    <div className="max-w-sm mx-auto py-20 px-4 space-y-6">
      <div className="text-center space-y-3">
        ...
        <h1 className="text-xl font-black text-[var(--color-text-primary)]">{t('loginTitle')}</h1>
        <p className="text-xs text-[var(--color-text-muted)]">{t('loginSubtitle')}</p>
      </div>
      ...
      <p className="text-[10px] text-[var(--color-text-muted)] text-center">{t('protected')}</p>
    </div>
  );
};
